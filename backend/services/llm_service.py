...
ВАЖНО: Здороваться со слушателями можно только в 1 из 10 случаев. В большинстве случаев сразу переходи к представлению трека без приветствия."""
    # При ElevenLabs добавляем явную инструкцию по ударениям для корректного произношения
    if get(db, "tts_provider") == "elevenlabs":
        prompt += "\n\nУДАРЕНИЯ: Текст будет озвучиваться ElevenLabs. Расставь ударения: после каждой ударной гласной в словах с неочевидным ударением ставь символ ́ (U+0301). Примеры: прекра́сный, мо́локо, зво́нит, жалюзи́."
